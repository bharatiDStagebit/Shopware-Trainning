...
<h2>";
        // line 2
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["pagelet"] ?? null), "staticdata", [], "any", false, false, false, 2), "html", null, true);
        echo "</h2>
...
";
    ...
    {
        return new Source("
<h2>{{pagelet.staticdata}}</h2>
  
", "@SwagQuickstartTheme/storefront/pagelet/example/index.html.twig", "/var/www/html/custom/plugins/SwagQuickstartTheme/src/Resources/views/storefront/pagelet/example/index.html.twig");
    }
}
