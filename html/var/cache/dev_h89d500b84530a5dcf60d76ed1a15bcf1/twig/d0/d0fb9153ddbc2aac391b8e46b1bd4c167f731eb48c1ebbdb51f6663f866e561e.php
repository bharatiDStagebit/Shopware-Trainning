...
($context["searchResult"] ?? null), "availableSortings", [], "any", false, false, false, 44)]));
    ...
    public function block_element_product_listing_box($context, array $blocks = [])
    {
        ...
        // line 59
        echo "                                            ";
        $this->loadTemplate("@SwagQuickstartTheme/storefront/component/product/card/box.html.twig", "@Storefront/storefront/component/product/listing.html.twig", 59)->display(twig_array_merge($context, ["layout" =>         // line 60
